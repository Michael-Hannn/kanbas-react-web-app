export default function Lab1() {
    return (
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Tacos!
        <ol id="wd-your-favorite-recipe">
          <li>Season ground beef.</li>
          <li>Heat up pan and cook ground beef.</li>
          <li>While ground beef cooks cut vegetables.</li>
          <li>Once Ground beef is all cooked set aside and warm up tortilla.</li>
          <li>Assemble your taco to your taste.</li>
          <li>Enjoy!</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-starship" alt="starship wrm up"
          width="400px"
        ...
        <br />
        <img id="wd-teslabot" src="images/teslabot.jpg" height="200px" alt="the tesla bot"/>
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
        <form id="wd-text-fields">
          ...
          Please 
          <a id="wd-github" href="https://github.com/Michael-Hannn/kanbas-react-web-app.git"> click here</a>
